            ...
            <div className='sidebar'>
                <div className='menu'>
                    ...
                    <div className='menu-list'>
                        <MenuLink label='Quản lý cơ hội' to="/lead" activeOnlyWhenExact='true' >
                        ...
                        <MenuLink label='Xử lý cơ hội' to="/processing" activeOnlyWhenExact='true' >
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <MenuLink label='Quản lý phiếu khám' to="/order" activeOnlyWhenExact='true' >
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <MenuLink label='Lịch' to="/calendar" activeOnlyWhenExact='true' >
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <MenuLink label='Quản lý khách hàng' to="/customer" activeOnlyWhenExact='true' >
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <MenuLink label='Quản lý dịch vụ' to="/service" activeOnlyWhenExact='true' >
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <MenuLink label='Quản lý người dùng' to="/user" activeOnlyWhenExact='true' >
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
