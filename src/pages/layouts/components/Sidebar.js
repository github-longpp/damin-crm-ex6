                ...
                <Pane flexDirection='column' className='flex h-full px-4 py-3'>
                    <Pane className='menu-title w-auto flex justify-between items-center mb-8'>
                        ...
                        <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <path d="M30 20H11" stroke="#11142D" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                            <path d="M30 12H21" stroke="#808191" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                            <path opacity="0.301406" d="M30 28H21" stroke="#808191" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                            <path d="M15 15L10 20L15 25" stroke="#11142D" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                        </svg>
                    </Pane>
                    <Pane className='flex flex-col'>
                        ...
                        <Link to='/processing'>
                            <Pane className={`menu-item flex h-12 w-auto px-3 items-center cursor-pointer mt-2 rounded-md ${this.context.activeMenu === 'processing' ? 'active' : ''}`}>
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M7.24487 14.7815L10.238 10.8914L13.6522 13.5733L16.5813 9.79297" stroke="#130F26" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                    <circle cx="19.9954" cy="4.20027" r="1.9222" stroke="#130F26" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                    <path d="M14.9245 3.12024H7.65679C4.64535 3.12024 2.77808 5.25296 2.77808 8.2644V16.3468C2.77808 19.3582 4.60874 21.4818 7.65679 21.4818H16.2609C19.2724 21.4818 21.1396 19.3582 21.1396 16.3468V9.30788" stroke="#130F26" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                </svg>
                                <Pane className='menu-text pl-4 font-medium leading-snug not-italic text-sm'>
                                    Xử lý cơ hội
                                </Pane>
                        ...
                        <Link to='/calendar'>
                            <Pane className={`menu-item flex h-12 w-auto px-3 items-center cursor-pointer mt-2 rounded-md ${this.context.activeMenu === 'calendar' ? 'active' : ''}`}>
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M3.09253 9.40421H20.9165" stroke="#130F26" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                    <path d="M16.442 13.3097H16.4512" stroke="#130F26" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                    <path d="M12.0047 13.3097H12.014" stroke="#130F26" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                    <path d="M7.55793 13.3097H7.5672" stroke="#130F26" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                    <path d="M16.442 17.1962H16.4512" stroke="#130F26" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                    <path d="M12.0047 17.1962H12.014" stroke="#130F26" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                    <path d="M7.55793 17.1962H7.5672" stroke="#130F26" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                    <path d="M16.0438 2V5.29078" stroke="#130F26" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                    <path d="M7.9654 2V5.29078" stroke="#130F26" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                        ...
                        <Link to='/customer'>
                            <Pane className={`menu-item flex h-12 w-auto px-3 items-center cursor-pointer mt-2 rounded-md ${this.context.activeMenu === 'customer' ? 'active' : ''}`}>
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <path fillRule="evenodd" clipRule="evenodd" d="M9.59157 12.0198C7.16957 12.0198 5.20557 10.0568 5.20557 7.63476C5.20557 5.21276 7.16957 3.24976 9.59157 3.24976C12.0126 3.24976 13.9766 5.21276 13.9766 7.63476C13.9856 10.0478 12.0356 12.0108 9.62257 12.0198H9.59157Z" stroke="#130F26" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                    <path d="M16.4832 10.8815C18.0842 10.6565 19.3172 9.28253 19.3202 7.61953C19.3202 5.98053 18.1252 4.62053 16.5582 4.36353" stroke="#130F26" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                    <path d="M18.5955 14.7322C20.1465 14.9632 21.2295 15.5072 21.2295 16.6272C21.2295 17.3982 20.7195 17.8982 19.8955 18.2112" stroke="#130F26" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                </svg>
                                <Pane className='menu-text pl-4 font-medium leading-snug not-italic text-sm'>
                                    Quản lý khách hàng
                                </Pane>
                        ...
                        <Link to='/user'>
                            <Pane className={`menu-item flex h-12 w-auto px-3 items-center cursor-pointer mt-2 rounded-md ${this.context.activeMenu === 'user' ? 'active' : ''}`}>
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <path d="M9.38599 11.8746L11.278 13.7696L15.176 9.86963" stroke="#130F26" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                </svg>
                                <Pane className='menu-text pl-4 font-medium leading-snug not-italic text-sm'>
                                    Quản lý người dùng
                                </Pane>
